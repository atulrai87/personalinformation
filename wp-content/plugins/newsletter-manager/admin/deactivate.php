...
$wpdb->update($wpdb->prefix.'posts', array('post_status'=>'draft'), array('id'=>$pageIdUnsubscribe));
...
$wpdb->update($wpdb->prefix.'posts', array('post_status'=>'draft'), array('id'=>$pageIdThanks));
...
$wpdb->update($wpdb->prefix.'posts', array('post_status'=>'draft'), array('id'=>$pageIdConfirm));

update_option("xyz_em_active",0);//for cron
